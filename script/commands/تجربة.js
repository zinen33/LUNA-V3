...
module.exports.run = function ({ api, event }) {
    api.sendMessage(
        ...
        event.threadID,
        (err, info) => {
            setTimeout(() => api.editMessage(info.messageID, "محمد"), 3000);
            setTimeout(() => api.editMessage(info.messageID, "و"), 6000);
            setTimeout(() => api.editMessage(info.messageID, "زينو"), 9000);
           setTimeout(() => api.editMessage(info.messageID, "انتاج البوت الاسطوري く愛[ . ]↬ 𝗕𝗢𝗧 𝗟𝗨𝗡𝗔↫⚠️☠️🇩🇿"), 12000);
        },
        event.messageID
    );
};
